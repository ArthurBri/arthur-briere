<template>
  <canvas ref="valuesWallRef"></canvas>
</template>

<script setup lang="ts">
// import { onMounted } from 'vue'

// const valuesWallRef =ref()
...
// var canvas = valuesWallRef.value
...
//   // constructor
//   let Word = function (key) {
//     console.log(words[key], key)
//     this.text = key
...
//   }
//   console.log(key, words_attr.length)
