    ...
    <div class="flex justify-start flex-wrap">
        <div class="card flex items-center bg-white rounded-lg shadow-lg mx-2 mb-2 p-2 dark:bg-gray-800 dark:text-white" v-for="(skill, index) in filteredSKills"
            ...
            <div class="flex items-center justify-center">
                ...
                <div class="flex ml-4" v-if="skill.stars">
                    <div class="text-left" v-for="index in Math.floor(skill.stars)" :key="index">
                    ...
                    <div v-if="skill.stars % 1 !== 0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-star-half" width="20" height="20" viewBox="0 0 24 24" stroke-width="1" stroke="#009688" fill="none" stroke-linecap="round" stroke-linejoin="round">
