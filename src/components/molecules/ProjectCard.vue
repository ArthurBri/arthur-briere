      ...
      <div class="card p-4 flex h-full justify-between flex-col w-full rounded-lg">
        ...
        <div class="card-footer">
          <div class="tags flex flex-wrap mt-2 gap-2">
            <div class="flex text-xs bg-ab-primary bg-opacity-10 dark:bg-white dark:text-ab-gray rounded-md p-1 px-1 whitespace-nowrap"
                  v-for="tag in tagNames" :key="tag.name">
