            ...
            <div class="sidebar-start flex flex-col mt-8">
                    ...
                    <div class="flex flex-col justify-center items-end mr-4 pr-2">
                        ...
                        <div class="links flex stroke-current dark:text-white">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" @click="mailMe"
                                 class="icon icon-tabler icon-tabler-mail ml-2 cursor-pointer animate-scale stroke-current dark:text-white" width="30"
                                 height="30"
                                 viewBox="0 0 24 24" stroke-width="1" stroke="#2c3e50" fill="none"
                                 stroke-linecap="round"
                                 stroke-linejoin="round">
                ...
                <div class="text-base text-justify px-4 mt-4">
                    ...
                    <div class="mb-4 text-center flex justify-center dark:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-2 stroke-current" width="20" height="20" viewBox="0 0 24 24" stroke-width="1" stroke="#03A9F4" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        ...
                        </svg><span class="ml-2">Rennes, France</span></div>
                    <p class="leading-loose dark:text-white">Je soigne l'aspect <span class="animate-text">créatif</span> de mes projets. Je
